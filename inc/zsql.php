<?php
	...
	define("EZSQL_DB_USER"		, "492130_root10");										// <-- mysql db user
	define("EZSQL_DB_PASSWORD"	, "6ujusWU6eS2s");										// <-- mysql db password
	define("EZSQL_DB_NAME"		, "492130_apps10_mktg00");								// <-- mysql db pname
	define("EZSQL_DB_HOST"		, "mysql51-001.wc2.dfw1.stabletransit.com");			// <-- mysql server host
